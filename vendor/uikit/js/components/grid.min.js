	...
	function i() {
		...
		function o(t) {
			if (
				...
				for (
					var h = (o.isBorderBox = !(!a || !e[a] || "border-box" !== e[a])),
						u = 0,
						l = c.length;
					l > u;
					u++
	...
	t.component("grid", {
		...
		_prepareElements: function () {
			...
			i.length &&
				...
				this.options.gutter &&
					((t["padding-" + this.origin] = this.gutterh),
				...
				f.each(function () {
					for (
						...
						(a = v[h]),
							...
							g + o > p && (g = 0),
							m <= a.aY && (m = a.aY);
					(d = { ele: r, top: m, width: o, height: s, aY: m + s, aX: g + o }),
						(d[n.origin] = g),
						v.push(d);
				});
			var b,
